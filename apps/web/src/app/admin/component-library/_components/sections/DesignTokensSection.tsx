...
const COLOR_GROUPS = [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Abyss', hex: '#0a0f1e', className: 'bg-abyss' },
      { name: 'Surface', hex: '#111827', className: 'bg-surface' },
      { name: 'Elevated', hex: '#1f2937', className: 'bg-elevated' },
      { name: 'Hover', hex: '#374151', className: 'bg-hover' },
    ],
  },
  {
    label: 'Accents',
    colors: [
      { name: 'Cyan', hex: '#06b6d4', className: 'bg-accent-cyan' },
      { name: 'Violet', hex: '#8b5cf6', className: 'bg-accent-violet' },
      { name: 'Amber', hex: '#f59e0b', className: 'bg-accent-amber' },
      { name: 'Emerald', hex: '#10b981', className: 'bg-accent-emerald' },
      { name: 'Rose', hex: '#f43f5e', className: 'bg-accent-rose' },
      { name: 'Blue', hex: '#3b82f6', className: 'bg-accent-blue' },
    ],
  },
  {
    label: 'Text',
    colors: [
      { name: 'Primary', hex: '#f1f5f9', className: 'bg-[#f1f5f9]' },
      { name: 'Secondary', hex: '#94a3b8', className: 'bg-[#94a3b8]' },
      { name: 'Muted', hex: '#64748b', className: 'bg-[#64748b]' },
    ],
  },
];
