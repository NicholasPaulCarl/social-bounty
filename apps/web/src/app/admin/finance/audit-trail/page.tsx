    ...
    <>
      ...
      <Card>
        <DataTable value={data ?? []} size="small" stripedRows paginator rows={25}>
          ...
          <Column field="entityId" header="Entity ID" body={(r) => <span className="font-mono text-xs">{r.entityId}</span>} />
          <Column field="actorId" header="Actor" body={(r) => <span className="font-mono text-xs">{r.actorId.slice(0, 8)}…</span>} />
