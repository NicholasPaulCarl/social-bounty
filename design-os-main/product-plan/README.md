# Social Bounty — Design Handoff

This folder contains everything needed to implement Social Bounty.
...
- `instructions/incremental/` — 6 milestone instructions (shell, then sections)
